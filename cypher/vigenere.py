...
def vigenereCipher(content, key):
    """
...
if __name__ == '__main__':
    content = "Hola este es un ejemplo"
    key = "abcde"

    out, _ = vigenereCipher(content, key)
    print("Contenido cifrado: ", out)

    badKey = "yehsa"
    out2, _ = vigenereCipher(out, badKey)

    print("Resultado con una llave que no es: ", out2)

    out3, _ = vigenereCipher(out, key)
    print("Resultado con una llave que SI es: ", out3)